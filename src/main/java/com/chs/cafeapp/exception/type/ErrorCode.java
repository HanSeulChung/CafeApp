...
public enum ErrorCode {
  ...
  ALREADY_EXISTS_MEMBER_LOGIN_ID(400, "이미 존재하는 아이디 입니다. 다른 아이디로 회원가입 진행 가능합니다."),
  ...
  EXPIRED_DATE_TIME_FOR_EMAIL_AUTH(400, "이메일 인증은 메일 전송 24시간 이내에 해주셔야 합니다. 이메일을 다시 보냈습니다. 인증을 24시간 이내에 해주십시오."),
  NOT_EMAIL_AUTH(400, "이메일 인증 후 로그인이 가능합니다."),
  NOT_EXISTS_MEMBER_LOGIN_ID(400, "로그인 아이디가 존재하지 않습니다. 다시 확인해 주십시오."),
  NOT_MATCH_MEMBER_PASSWORD(400, "로그인 비밀번호가 틀렸습니다."),
